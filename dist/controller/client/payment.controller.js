...
export const payment = async (req, res) => {
    try {
        ...
        let { accessKey, secretKey, orderInfo, partnerCode, requestType, orderGroupId, autoCapture, lang, } = system;
...
export const paymentCallback = async (req, res) => {
    try {
        ...
        if (resultCode == 0) {
            ...
            const confirmedBooking = newBookingInstance.get({ plain: true });
            // ---- ĐOẠN CODE KÍCH HOẠT GỬI MAIL TỰ ĐỘNG ----
